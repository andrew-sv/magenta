...
function Bubble({ message }: { message: Message }) {
  ...
  if (isUser) {
    return (
      <div className="flex justify-end">
        <div className="max-w-[90%] whitespace-pre-wrap rounded-2xl bg-magenta-600 px-3 py-2 text-sm text-white shadow-sm">
          {message.content}
        </div>
      </div>
    );
  ...
  return (
    <div className="flex justify-start">
      <div className="max-w-[90%] rounded-2xl bg-white px-3 py-2 text-sm shadow-sm dark:bg-neutral-900">
        {message.content ? (
